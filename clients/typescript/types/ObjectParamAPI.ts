...
export class ObjectItemsApi {
  ...
  public constructor(
    ...
    this.api = new ObservableItemsApi(
      configuration,
      requestFactory,
      responseProcessor,
    );
  ...
  public createItemWithHttpInfo(
    param: ItemsApiCreateItemRequest,
    options?: ConfigurationOptions,
  ): Promise<HttpInfo<Item>> {
    return this.api
      .createItemWithHttpInfo(param.itemInput, options)
      .toPromise();
  }
  ...
  public deleteItemWithHttpInfo(
    param: ItemsApiDeleteItemRequest,
    options?: ConfigurationOptions,
  ...
  public listItemsWithHttpInfo(
    param: ItemsApiListItemsRequest = {},
    options?: ConfigurationOptions,
  ): Promise<HttpInfo<ItemList>> {
