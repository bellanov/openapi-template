...
| ---------- | --------------------------------------------- | -------------------------- | -------------- |
| _ItemsApi_ | [**createItem**](docs/ItemsApi.md#createItem) | **POST** /items            | Create an item |
| _ItemsApi_ | [**deleteItem**](docs/ItemsApi.md#deleteItem) | **DELETE** /items/{itemId} | Delete an item |
| _ItemsApi_ | [**getItem**](docs/ItemsApi.md#getItem)       | **GET** /items/{itemId}    | Get an item    |
| _ItemsApi_ | [**listItems**](docs/ItemsApi.md#listItems)   | **GET** /items             | List all items |
